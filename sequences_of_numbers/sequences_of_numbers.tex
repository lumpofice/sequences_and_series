...
\begin{theorem}
If $\{f(n)\}_{n}^{\infty}$ and $\{g(n)\}_{n}^{\infty}$ are convergent sequences, and if $c \in \mathbb{R}$, then
\begin{align*}
...
Find the limit of
\begin{align*}
    \Big\{\tan\Big(\dfrac{2n\pi}{1+8n}\Big)\Big\}_{n}^{\infty}
\end{align*}
\end{exercise}
...
Find the limit of
\begin{align*}
    \Big\{\sqrt{\dfrac{n+1}{9n+1}}\Big\}_{n}^{\infty}
\end{align*}
\end{exercise}
