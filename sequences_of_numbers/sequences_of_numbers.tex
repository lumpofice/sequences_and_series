...
\begin{align*}
    ...
    &ii) \hspace{4pt} \lim_{n \longrightarrow \infty} cf(n) = c\lim_{n \longrightarrow \infty} f(n)\\[2ex]
    &iii) \hspace{4pt} \lim_{n \longrightarrow \infty}(f(n) - g(n)) = \lim_{n \longrightarrow \infty} f(n) - \lim_{n \longrightarrow \infty} g(n)\\[2ex]
    &iv) \hspace{4pt} \lim_{n \longrightarrow \infty} (f(n) \cdot g(n)) = \lim_{n \longrightarrow \infty} f(n) \cdot \lim_{n \longrightarrow \infty} g(n)\\[2ex]
...
\begin{proof} 
    \hspace{2pt}\\[1ex]
    \text{Since } $\{f(n)\}_{n = 1}^{\infty}$ \text{ and } $\{g(n)\}_{n = 1}^{\infty}$
    \begin{align*}
        &\text{Since } \{f(n)\}_{n = 1}^{\infty} \text{ and } \{g(n)\}_{n = 1}^{\infty} \text{ are convergent, we let there limits be } f \text{ and } g, \text{ respectively.} \\[2ex]
        &i) \hspace{4pt} \text{Take } \epsilon \hspace{2pt} > \hspace{2pt} 0; \text{ then there exists } K_{1} \in \mathbb{N} \text{ such that } \forall n \hspace{2pt} \geq \hspace{2pt} K_{1}, \\
        &\text{and there exists } K_{2} \in \mathbb{N} \text{ such that } \forall n \hspace{2pt} \geq \hspace{2pt} K_{2}, \text{ we have}
    \end{align*}
    \begin{align*}
    ...
    \begin{align*}
        ...
        &\lvert (f(n) - g(n)) - (f-g) \rvert = \lvert (f(n) - f) + (g - g(n)) \rvert \hspace{2pt} \leq \hspace{2pt} \lvert f(n) - f \rvert + \lvert g(n) - g \rvert \hspace{2pt} < \hspace{2pt} 2\epsilon
    \end{align*}
    \begin{align*}
        &\text{Since } \{f(n)\}_{n = 1}^{\infty} \text{ and } \{(-1)g(n)\}_{n = 1}^{\infty} \text{ are convergent, we let there limits be } f \text{ and } -g \text{, respectively} \\[2ex]
        &iii) \hspace{4pt} \text{Take } \epsilon \hspace{2pt} > \hspace{2pt} 0; \text{ then there exists } K_{1} \in \mathbb{N} \text{ such that } \forall n \hspace{2pt} \geq \hspace{2pt} K_{1}, \\
        &\text{and there exists } K_{2} \in \mathbb{N} \text{ such that } \forall n \hspace{2pt} \geq \hspace{2pt} K_{2}, \text{ we have}
    \end{align*}
    \begin{align*}
        \lvert f(n) - f \rvert \hspace{2pt} < \hspace{2pt} \epsilon \hspace{20pt} \text{and} \hspace{20pt} \lvert (-g(n)) - (-g) \rvert \hspace{2pt} < \hspace{2pt} \epsilon. 
