...
\begin{proof} 
    ...
    \end{align*}
    \text{So, we have our limit for } $\Big\{\dfrac{1}{g(n)}\Big\}$
    \begin{align*}
    ...
    \begin{align*}
        \lim_{n \longrightarrow \infty} \dfrac{f(n)}{g(n)} \hspace{2pt} = \hspace{2pt} \lim_{n \longrightarrow \infty} f(n) \varphi (n) \hspace{2pt} = \hspace{2pt} f \cdot \varphi \hspace{2pt} = \hspace{2pt} \dfrac{f}{g} 
    \end{align*}
\end{proof}
\end{theorem}
