...
\begin{align*}
    ...
    &ii) \hspace{4pt} \lim_{n \longrightarrow \infty}(f(n) - g(n)) = \lim_{n \longrightarrow \infty} f(n) - \lim_{n \longrightarrow \infty} g(n)\\[2ex]
...
\begin{proof}
    \begin{align*}
        ...
        &\text{and there exists } K_{2} \in \mathbb{N} \text{ such that } \forall n \hspace{2pt} \geq \hspace{2pt} K_{2}, \text{ such that}
        \end{align*}
        \begin{align*}
