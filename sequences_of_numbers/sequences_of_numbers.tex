...
\begin{proof}
    \begin{align*}
        &i) \hspace{4pt} (a + b)^{2} = a^{2} + 2ab + b^{2} \hspace{2pt} \leq \hspace{2pt} \lvert a \rvert ^{2} + 2 \lvert a \rvert \lvert b \rvert + \lvert b \rvert ^{2} = (\lvert a \rvert + \lvert b \rvert)^{2} \\[2ex]
        &\text{this gives us} \\[2ex]
        &\lvert a + b \rvert = \sqrt{(a + b)^{2}} \hspace{2pt} \leq \hspace{2pt} \sqrt{(\lvert a \rvert + \lvert b \rvert)^{2}} = \Big\lvert \lvert a \rvert + \lvert b \rvert \Big\rvert = \lvert a \rvert + \lvert b \rvert \\[4ex]
        &ii) \hspace{4pt} \lvert a - b \rvert = \lvert a - c + c - b \rvert \hspace{2pt} \leq \hspace{2pt} \lvert a - c \rvert + \lvert c - b \rvert
    \end{align*}
\end{proof}
\end{recall}
