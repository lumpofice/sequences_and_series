...
\begin{tikzpicture}[scale=\textwidth/6.2cm]
    ...
    % ----------------------------------
    % graph
    \draw[blue] plot[smooth] file {limits_of_functions/rational_neg1half_2_piece_0.table};
    \draw[blue] plot[smooth] file {limits_of_functions/rational_neg1half_2_piece_1.table};
