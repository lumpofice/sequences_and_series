...
\end{align*}
When $f$ is continuous on the domain $[a, b]$, we call $g$ an antidervative of $f$. 
\end{theorem}
...
\end{align*}
The right hand side of the equality evaluates to $26/3$. Of course, we can always revert back to expressions in terms of $x$.
\begin{align*}
