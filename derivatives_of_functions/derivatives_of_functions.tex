...
\begin{tikzpicture}[scale=\textwidth/4.2cm]
    ...
    \draw (0, 0) -- (0, 2.4)
        node[above] {$f(x)$};
    % graph
    \draw[red, very thick] plot[smooth] file {derivatives_of_functions/python_generated_tables/tangent_0_pi.table};
    \draw[black] plot[smooth] file {derivatives_of_functions/python_generated_tables/secant1_0_pi.table};
    \draw[black] plot[smooth] file {derivatives_of_functions/python_generated_tables/secant2_0_pi.table};
